...
STDAPI DllRegisterServer()
{
	...
	__try
	{
		...
		// 32bit server on 32bit OS -> HKEY_CLASSES_ROOT\CLSID\{}
		// 32bit server on 64bit OS -> HKEY_CLASSES_ROOT\Wow6432Node\CLSID\{}
		// 64bit server on 32bit OS -> Invalid
		// 64bit server on 64bit OS -> HKEY_CLASSES_ROOT\CLSID\{}

		lRet = RegCreateKeyEx(HKEY_CLASSES_ROOT, TEXT("CLSID\\{}"), 0, NULL, REG_OPTION_NON_VOLATILE, KEY_SET_VALUE | KEY_CREATE_SUB_KEY, NULL, &hCLSIDKey, NULL);
		...
		lRet = RegSetValueEx(hInProcSvrKey, TEXT("ThreadModel"), 0, REG_SZ, (const BYTE*)szThreadingModel, sizeof(szThreadingModel));
...
{
	RegDeleteKey(HKEY_CLASSES_ROOT, TEXT("CLSID\\{C331AB68-B16E-4092-B6D7-54E1DD16E574}\\InProcServer32"));

	RegDeleteKey(HKEY_CLASSES_ROOT, TEXT("CLSID\\{C331AB68-B16E-4092-B6D7-54E1DD16E574}"));
